  ...
  return (
    ...
    >
      <h2 className="text-center">
        ...
        <b className="bg-blue-100 p-1 rounded">Save edits</b> button at the
        bottom of the page
      </h2>
      ...
      <div className="flex flex-col p-2 bg-slate-300/70">
        <button
          className="flex py-2 w-[fit-content] mt-4 bg-blue-300 px-2 items-center"
          type="submit"
          id={note.id}
          onClick={() => handleFirebaseEdit(note.id) && handleEditChange}
        >
          <p>Save edits</p>
          <IoIosCreate size={28} />
        </button>
